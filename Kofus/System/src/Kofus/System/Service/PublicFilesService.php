...
class PublicFilesService extends AbstractService
{
	...
	{
	    $libPath = KOFUS_MODULE_SYSTEM_PATH . '/public/';
	    if (strpos($filename, $libPath) !== false)
	       return str_replace($libPath, '/cache/public', $filename);
	...
	{
	    return $this->config()->get('public_paths', array());
	    return array(
	        'public', 
	        KOFUS_MODULE_SYSTEM_PATH  . '/public/'
	    );
	}
