...
class Drupal extends AbstractAdapter implements AdapterInterface
{
    ...
    public function authenticate()
    {
        ...
        $account->pass = $this->getIdentity()->getCredential();
        if ($this->user_check_password($this->getCredential(), $account))
